...
var (
	...
	// VramMinFree sets the minimum free VRAM to maintain per GPU
	VramMinFree = Uint64("OLLAMA_VRAM_MIN_FREE", 0)
...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_CONTEXT_LENGTH":    {"OLLAMA_CONTEXT_LENGTH", ContextLength(), "Context length to use unless otherwise specified (default: 16384)"},
